    ...
    rows: list[dict[str, object]] = [
        {
            ...
            "proposed_next_tasks": "Use the recorded P1-22 capped-weight and stratified-loss failures as negative evidence; close P1-23 with the current hurdle, reference, and calibration results.",
            "expected_artifacts": "Final policy decision note, calibrated predictions, station-vs-background metric summary.",
